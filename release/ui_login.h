...
public:
    ...
    void setupUi(QWidget *login)
    {
        ...
        toolButton = new QPushButton(login);
...
"font: 12pt \"\351\273\221\344\275\223\";"));
    ...
    void retranslateUi(QWidget *login)
    {
        ...
        toolButton->setToolTip(QApplication::translate("login", "<html><head/><body><p><img src=\":/keyboard.png\"/></p></body></html>", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
        toolButton->setWhatsThis(QApplication::translate("login", "<html><head/><body><p><img src=\":/keyboard.png\"/></p></body></html>", 0));
