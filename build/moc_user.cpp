...
QT_MOC_LITERAL(4, 21, 14),
QT_MOC_LITERAL(5, 36, 28),
QT_MOC_LITERAL(6, 65, 26)
    },
    "user\0display\0\0number\0showFullScreen\0"
...
void user::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->on_pushButton_finish_clicked(); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&user::display)) {
                *result = 0;
            }
        }
        {
            typedef void (user::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&user::showFullScreen)) {
                *result = 1;
            }
        }
    }
